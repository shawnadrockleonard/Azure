...
.EXAMPLE
    ...
    .\azuread-app-reg.ps1 -subscriptionName "<az subscription>" -password $securepassword -environmentName AzureUSGovernment -Verbose
    .\azuread-app-reg.ps1 -subscriptionName "<az subscription>" -password $securepassword -spnRole contributor -environmentName AzureUSGovernment -Verbose    
